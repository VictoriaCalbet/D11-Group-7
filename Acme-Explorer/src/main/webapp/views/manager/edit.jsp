...
<form:form action="${requestURI}" modelAttribute="manager">
	...
	<spring:message var="patternMessage" code="manager.phone.pattern"/>
	
	<input type="submit" name="save" value="<spring:message code="manager.save"/>" onclick="return checkPhone('${patternMessage}')"/>
	<input type="button" name="cancel" value="<spring:message code="manager.cancel"/>" onclick="javascript: relativeRedir('welcome/index.do');"/>

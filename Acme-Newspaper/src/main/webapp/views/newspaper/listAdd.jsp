...
<display:table name="newspapers" id="row" requestURI="${requestURI}" pagesize="5">
	...
	<security:authorize access="hasRole('USER')">
		<spring:message code="newspaper.add" var="addHeader" />	
		<display:column title="${addHeader}" style="${style}">	
			<a href="newspaper/user/addNewspaper.do?newspaperId=${row.id}&volumeId=${volumeId}">
			 	<spring:message code="newspaper.addButton" />
			</a>
		</display:column>
	</security:authorize>
